...
const GChangePassword = () => {
    ...
    async function onSubmit(data) {
        try {
            const url = "http://localhost:3000/guard/change-password";
    ...
    return (
        <div className="security-page">
            <div className="security-container py-5">
                <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-lg-5 d-none d-lg-flex flex-column text-white align-items-center justify-content-center text-center">
                        <div className="security-card sec-profile-card security-hero-card d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <div className="col-lg-6 col-md-8">
                        <div className="security-card security-card-body p-4 p-md-5">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {/* Current Password */}
                                <div className="mb-3">
                                    <label className="form-label security-label" htmlFor="current_password">Current Password</label>
                                ...
                                {/* New Password */}
                                <div className="mb-3">
                                    <label className="form-label security-label" htmlFor="new_password"> New Password</label>
                                ...
                                {/* Confirm Password */}
                                <div className="mb-4">
                                    <label className="form-label security-label" htmlFor="confirm_password"> Confirm Password </label>
                                ...
                                <div className="d-grid gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        className="btn security-btn w-100 py-3 text-white"
                                    >
