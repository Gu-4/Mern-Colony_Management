...
(function ($) {
	...
	window.addEventListener("scroll", function () {
		const btn = document.querySelector(".back-to-top-wrapper");

		if (!btn) return;

		if (window.scrollY > 200) {
			btn.classList.add("back-to-top-btn-show");
		} else {
			btn.classList.remove("back-to-top-btn-show");
		}
	});
	back_to_top();
	...
	if ($('.service-h1-slider').length) {
		var swiper = new Swiper(".service-h1-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
	...
	if ($('.service-h3-slider').length) {
		var swiper = new Swiper(".service-h3-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
	...
	if ($('.client-h1-slider').length) {
		var swiper = new Swiper(".client-h1-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
	...
	if ($('.client-h3-slider').length) {
		var swiper = new Swiper(".client-h3-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
	...
	if ($('.feature-h3-slider').length) {
		var swiper = new Swiper(".feature-h3-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
	...
	if ($('.testi-h1-slider').length) {
		var swiper = new Swiper(".testi-h1-slider", {
			speed: 1000,
			autoplay: true,
			loop: true,
			slidesPerView: 1,
